...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['owner', 'administrator', 'course-instructor', 'job-trainer'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Contests', path: '/contests', entity: 'contest', service: AccessServiceEnum.PROJECT, icon: FiAward },
