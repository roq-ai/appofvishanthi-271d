...
export function CourseListPage(props: CourseListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getCourses({
        relations: ['user', 'assignment.count', 'examination.count', 'student_progress.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('assignment', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('examination', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'examination',
          header: 'Examination',
          accessorKey: 'examination',
          cell: ({ row: { original: record } }: any) => record?._count?.examination,
        }
      : null,
    hasAccess('student_progress', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          ...
          accessorKey: 'student_progress',
          cell: ({ row: { original: record } }: any) => record?._count?.student_progress,
        }
      : null,
