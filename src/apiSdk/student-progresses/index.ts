...
export const getStudentProgresses = async (
  query?: StudentProgressGetQueryInterface,
): Promise<PaginatedInterface<StudentProgressInterface>> => {
  const response = await axios.get('/api/student-progresses', {
    params: query,
